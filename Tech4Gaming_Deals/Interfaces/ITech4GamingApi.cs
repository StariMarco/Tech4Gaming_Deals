...
namespace Tech4Gaming_Deals.Interfaces
{
    public interface ITech4GamingApi
    {
        ...
        [Multipart]
        [Post("/api/products")]
        Task<Product> AddProduct([AliasAs("name")]string name, [AliasAs("price")]float price, [AliasAs("salePrice")]float salePrice, [AliasAs("url")]string url, [AliasAs("category")]string category, [AliasAs("description")]string descxription, [AliasAs("productImage")]ByteArrayPart bytes);
